...
////    @Published var figmaComponents = [FigmaSection<ComponentItem>]()
//
...
//
//    private var componentItemCache: [String: ComponentItem] = [:]
//    private var componentNamedCache: [String: ComponentItem] = [:]
//
//
...
//                self.componentItemCache[key]?.size = .init(width: size.width, height: size.height)
//            }
//        }
//    }
//    
...
//                    self.componentItemCache[key] = image
//                    self.componentNamedCache[value.name] = image
//                    return key
//                }).joined(separator: ",")
//
...
//                    self.componentItemCache[$0]?.x3 = $1
//                }
//                self.imageItems = self.componentItemCache.compactMap({$0.value})
//                DispatchQueue.main.async {
//                    self.figmaComponents = self.getSections(rows: self.imageItems)//self.imageItemNameDict.compactMap({$0.value})
//                }
//            case .failure(let err):
//                print(err)
//            }
